...
const casos: Caso[] = [
  {
    ...
    viaje: { km_total:2400, toneladas:35, viajes_por_mes:8,
  ...
  {
    nombre: 'cereal',
    viaje: { km_total:120, toneladas:31, viajes_por_mes:20,
  ...
  {
    nombre: 'lajitas',
    viaje: { km_total:760, toneladas:31, viajes_por_mes:12,
  ...
  {
    nombre: 'diamante',
    viaje: { km_total:2724, toneladas:31, viajes_por_mes:8,
  ...
  },
  {
    ...
    viaje: { km_total:2400, toneladas:31, viajes_por_mes:8,
             tarifa_neta_por_ton:81260, precio_gasoil:2060, consumo_camion:3, peajes_total:30000,
             chofer_por_km:130, chofer_por_dia:28000, modalidad_pago:'km_jornal', pct_sobre_tarifa:0 },
  ...
  {
    nombre: 'diamante 35t',
    viaje: { km_total:2724, toneladas:35, viajes_por_mes:8,
             tarifa_neta_por_ton:92200, precio_gasoil:2060, consumo_camion:3, peajes_total:30000,
             chofer_por_km:130, chofer_por_dia:28000, modalidad_pago:'km_jornal', pct_sobre_tarifa:0 },
  ...
  },
  {
    ...
    viaje: { km_total:3000, toneladas:31, viajes_por_mes:7,
